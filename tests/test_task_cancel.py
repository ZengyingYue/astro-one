...
def _make_loop():
    ...
    with patch("astro_one.agent.loop.ContextBuilder"), \
         patch("astro_one.agent.loop.SessionManager"), \
         patch("astro_one.agent.loop.SubagentManager") as MockSubMgr:
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        from astro_one.agent.subagent import SubagentManager
        from astro_one.bus.queue import MessageBus
        from astro_one.providers.base import LLMResponse, ToolCallRequest
        ...
        monkeypatch.setattr("astro_one.agent.tools.registry.ToolRegistry.execute", fake_execute)
