...
from astro_one.config.schema import ChannelsConfig
...
def test_discover_plugins_loads_entry_points():
    from astro_one.channels.registry import discover_plugins
...
def test_builtin_channel_default_config():
    ...
    from astro_one.channels.telegram import TelegramChannel
