...
from astro_one.config.schema import Config, InlineFallbackConfig, ModelPresetConfig
from astro_one.providers.base import LLMProvider
from astro_one.providers.fallback_provider import FallbackProvider
...
def _make_provider_core(
    ...
    *,
    ...
    if backend == "custom":
        ...
        from astro_one.providers.github_copilot_provider import GitHubCopilotProvider

        provider = GitHubCopilotProvider(default_model=model)
    elif backend == "anthropic":
        from astro_one.providers.anthropic_provider import AnthropicProvider
        ...
        from astro_one.providers.bedrock_provider import BedrockProvider
...
def load_provider_snapshot(
    ...
    *,
    ...
    from astro_one.config.loader import load_config, resolve_config_env_vars
