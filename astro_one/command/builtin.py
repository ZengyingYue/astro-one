...
from astro_one import __version__
from astro_one.bus.events import OutboundMessage
from astro_one.command.router import CommandContext, CommandRouter
from astro_one.utils.helpers import build_status_content
from astro_one.utils.restart import set_restart_notice_to_env
...
async def cmd_restart(ctx: CommandContext) -> OutboundMessage:
    ...
    async def _do_restart():
        ...
        os.execv(sys.executable, [sys.executable, "-m", "astro_one"] + sys.argv[1:])
...
async def cmd_status(ctx: CommandContext) -> OutboundMessage:
    ...
    with suppress(Exception):
        from astro_one.utils.searchusage import fetch_search_usage
...
async def cmd_pairing(ctx: CommandContext) -> OutboundMessage:
    """List, approve, deny or revoke pairing requests."""
    from astro_one.pairing import PAIRING_COMMAND_META_KEY, handle_pairing_command
