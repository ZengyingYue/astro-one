"""OpenAI-compatible HTTP API server for a fixed astro_one session.
...
from astro_one.config.paths import get_media_dir
...
from astro_one.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE
...
async def handle_chat_completions(request: web.Request) -> web.Response:
    ...
    model_name: str = request.app.get("model_name", "astro_one")
...
async def handle_models(request: web.Request) -> web.Response:
    """GET /v1/models"""
    model_name = request.app.get("model_name", "astro_one")
    return web.json_response(
        {
            "object": "list",
            "data": [
...
def create_app(
    agent_loop, model_name: str = "astro_one", request_timeout: float = 120.0
) -> web.Application:
