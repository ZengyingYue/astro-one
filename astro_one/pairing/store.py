...
Persistent storage at ``~/.astro_one/pairing.json`` keeps approved senders
...
from astro_one.config.paths import get_data_dir
from astro_one.utils.helpers import _write_text_atomic
