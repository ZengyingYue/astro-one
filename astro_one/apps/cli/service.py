...
from astro_one.apps.protocol import app_manifest, compact_dict
from astro_one.config.paths import get_runtime_subdir
...
class CliAppManager:
        ...
        *,
        ...
        remove = compact_dict({
            ...
            "verification": (
                ...
                else ["astro_one_state_absent", "managed_paths_absent"]
            ),
        })
        return app_manifest(
            app_id=name,
    ...
    def _fallback_skill(self, app: dict[str, Any]) -> str:
        ...
        description = str(app.get("description") or f"Use {display} from astro_one.")
        return f"""---
...
Use this skill when the user asks astro_one to operate {display} through its installed CLI app.
...
"""
    ...
    def _with_astro_one_skill_note(self, content: str, app: dict[str, Any]) -> str:
        marker = "<!-- astro_one-cli-app-note -->"
...
"""
    ...
    def install_skill(self, app: dict[str, Any]) -> Path:
        ...
        content = self._with_astro_one_skill_note(content, app)
    ...
    def uninstall(self, name: str) -> dict[str, Any]:
        ...
        if strategy != "bundled":
            ...
            if still_managed or (not managed_entry_path and still_available):
                ...
                message = (
                    ...
                    "so astro_one kept it installed."
                )
                return self.payload() | {
                    "last_action": {
                        "ok": False,
        ...
        if strategy == "bundled" and still_available:
            message = (
                f"Removed {app['display_name']} from astro_one. {entry_point} "
                "is still available because it is managed outside astro_one."
            )
