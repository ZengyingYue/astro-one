...
from astro_one.agent.hook import AgentHook, AgentHookContext
from astro_one.agent.tools.registry import ToolRegistry
from astro_one.providers.base import LLMProvider, LLMResponse, ToolCallRequest
from astro_one.utils.file_edit_events import (
...
from astro_one.utils.progress_events import (
...
class AgentRunner:
    ...
    async def _request_model(
        ...
        if timeout_s is None:
            ...
            # Set ASTRO_ONE_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("ASTRO_ONE_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
        ...
        # (ASTRO_ONE_STREAM_IDLE_TIMEOUT_S). Do not also apply the outer wall-clock
        # LLM timeout here, or healthy long reasoning streams can be killed just
        # because total elapsed time exceeded ASTRO_ONE_LLM_TIMEOUT_S.
