"""JSON Schema fragment types: all subclass :class:`~astro_one.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~astro_one.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~astro_one.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~astro_one.agent.tools.base.Schema`.
...
from astro_one.agent.tools.base import Schema
