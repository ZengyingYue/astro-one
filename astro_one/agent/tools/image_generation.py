...
from astro_one.agent.tools.base import Tool, tool_parameters
from astro_one.agent.tools.schema import (
    ArraySchema,
    IntegerSchema,
    StringSchema,
...
from astro_one.providers.image_generation import (
    ImageGenerationError,
    ImageGenerationProvider,
    get_image_gen_provider,
)
from astro_one.utils.artifacts import (
    ArtifactError,
    generated_image_tool_result,
    store_generated_image_artifact,
)
from astro_one.utils.helpers import detect_image_mime

if TYPE_CHECKING:
    from astro_one.config.schema import ProviderConfig
    ...
    def _resolve_reference_image(self, value: str) -> str:
        ...
        if not any(_is_relative_to(resolved, root) for root in allowed_roots):
            raise ImageGenerationError(
                "reference_images must be inside the workspace or astro_one media directory"
            )
