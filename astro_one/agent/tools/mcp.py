"""MCP client: connects to MCP servers and wraps their tools as native astro_one tools."""
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a astro_one Tool."""
...
async def request_mcp_reload(bus: Any, *, timeout: float = 15.0) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "ok": False,
            "message": "MCP hot reload timed out. Restart astro-one to pick up changes.",
