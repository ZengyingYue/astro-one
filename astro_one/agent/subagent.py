...
from astro_one.agent.tools.file_state import FileStates
...
from astro_one.config.schema import AgentDefaults, ToolsConfig
...
class SubagentManager:
    ...
    async def spawn(
        ...
        Returns a user-visible summary string indicating the subagent has started.
        """
    ...
    async def _announce_result(
        ...
        override = origin.get("session_key") or (
    ...
    def _build_subagent_prompt(self) -> str:
        """Build a focused system prompt for the subagent using templates."""
